...
function processSum(numberList,callback) {
  return callback(numberList.reduce(function(a,currentValue) {
...
function getFullNames(runners) {
  ...
  runners.forEach(function(currentValue){
    newRunners.push(`${currentValue.last_name}, ${currentValue.first_name}`)
  });
  return newRunners;
}
...
function firstNamesAllCaps(runners) {
  const newRunners = runners.map(function(currentValue){
